...
func (e TagEdges) ComicsOrErr() ([]*Comic, error) {
	if e.loadedTypes[0] {
		return e.Comics, nil
	}
...
// QueryComics queries the "comics" edge of the Tag entity.
func (t *Tag) QueryComics() *ComicQuery {
	return (&TagClient{config: t.config}).QueryComics(t)
}
