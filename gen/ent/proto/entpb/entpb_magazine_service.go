...
func toProtoMagazine(e *ent.Magazine) (*Magazine, error) {
	v := &Magazine{}
...
func toProtoMagazineList(e []*ent.Magazine) ([]*Magazine, error) {
	var pbList []*Magazine
...
func (svc *MagazineService) Create(ctx context.Context, req *connect_go.Request[CreateMagazineRequest]) (*connect_go.Response[Magazine], error) {
...
func (svc *MagazineService) Get(ctx context.Context, req *connect_go.Request[GetMagazineRequest]) (*connect_go.Response[Magazine], error) {
	var (
		err error
		get *ent.Magazine
	)
	...
	case GetMagazineRequest_VIEW_UNSPECIFIED, GetMagazineRequest_BASIC:
		get, err = svc.client.Magazine.Get(ctx, id)
	case GetMagazineRequest_WITH_EDGE_IDS:
...
func (svc *MagazineService) Update(ctx context.Context, req *connect_go.Request[UpdateMagazineRequest]) (*connect_go.Response[Magazine], error) {
	magazine := req.Msg.GetMagazine()
...
func (svc *MagazineService) Delete(ctx context.Context, req *connect_go.Request[DeleteMagazineRequest]) (*connect_go.Response[emptypb.Empty], error) {
	var err error
	var id uuid.UUID
	if err := (&id).UnmarshalBinary(req.Msg.GetId()); err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "invalid argument: %s", err)
...
func (svc *MagazineService) List(ctx context.Context, req *connect_go.Request[ListMagazineRequest]) (*connect_go.Response[ListMagazineResponse], error) {
	var (
		err      error
	...
	switch req.Msg.GetView() {
	case ListMagazineRequest_VIEW_UNSPECIFIED, ListMagazineRequest_BASIC:
		entList, err = listQuery.All(ctx)
	case ListMagazineRequest_WITH_EDGE_IDS:
	...
	case err == nil:
		...
		return connect_go.NewResponse(&ListMagazineResponse{
...
func (svc *MagazineService) BatchCreate(ctx context.Context, req *connect_go.Request[BatchCreateMagazinesRequest]) (*connect_go.Response[BatchCreateMagazinesResponse], error) {
	...
	case err == nil:
		...
		return connect_go.NewResponse(&BatchCreateMagazinesResponse{
			Magazines: protoList,
		}), nil
	case sqlgraph.IsUniqueConstraintError(err):
		return nil, status.Errorf(codes.AlreadyExists, "already exists: %s", err)
...
func (svc *MagazineService) createBuilder(magazine *Magazine) (*ent.MagazineCreate, error) {
